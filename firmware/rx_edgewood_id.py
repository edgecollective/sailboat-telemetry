    ...
    if len(msg) > 0:
        ...
        try:
            ...
            if len(parts) == 4:
                ...
                # Output in format expected by HTML viz
                print(f"{sailboat_id},{lat},{lon},0,{tilt},-70,{int(time.time() * 1000)},0")
            else:
                print("Invalid data format - expected 4 comma-separated values: sailboat_ID,lat,lon,tilt")
